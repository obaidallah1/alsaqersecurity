...
const translations = {
  ...
  ar: {
    ...
    aboutTitle: "من نحن",
    aboutText: "شركة الصقر لخدمات الأمن تسعى دائمًا لتوسيع خدماتها لتلبية احتياجات عملائها الكرام . بفضل خبرتنا الممتدة لأكثر من 25 عامًا، نواصل تقديم أعلى معايير الأمن.",
